...
Arithmetic subsequences in a random ordering of an additive set. {\sl arXiv preprint 2012.12339}, 11~pp.
To appear in {\sl Integers: Electronic Journal of Combinatorial Number Theory}, 2021.

\sectheader{Submitted Papers}

\pubbegin S
\subitem (with Anna M. Brandenberger and Luc Devroye)
Root estimation in Galton--Watson trees. {\sl arXiv preprint 2007.05681}, 20~pp.
Submitted July 2020.
\submittedcount=3
\subitem (with Anna M. Brandenberger, Luc Devroye, and Rosie Y. Zhao)
Leaf multiplicity in a Bienaym\'e--Galton--Watson tree. {\sl arXiv preprint 2105.12046}, 11~pp.
Submitted May 2021.
\subitem (with Jad Hamdan) The lattice of arithmetic progressions. {\sl arXiv preprint 2106.05949}, 8~pp.
Submitted June 2021.
\subitem (with Luc Devroye and Rosie Y. Zhao) The independence number of a Bienaym\'e--Galton--Watson tree
...
spaces, in various models of hyperbolic geometry. [R3]
\medbreak
...
ongoing work on the functional programming language Beluga. [R2]
\medbreak
...
It is implemented in OCaml using Ocamllex for lexing and Menhir for parsing. [R1]

\sectheader{Work and Volunteer Experience}

\leftright{\bf First responder}{\bf October 2017 -- present}
...
first-aid skills up-to-date. Most recent first responder certification: September 2021.
\medbreak

\leftright{\bf Grader}{\bf September 2019 -- April 2021}
...
\leftright{\bf Helpdesk tutor}{\bf September 2018 -- April 2021}
...
\leftright{\bf Painter}{\bf May -- August 2018}
...
\leftright{\bf Infantryman}{\bf August 2015 -- August 2017}
...
\leftright{\bf Tutor}{\bf September 2014 -- June 2015}
...
\leftright{\bf Summer camp counsellor}{\bf June -- August 2014}
...
\smallskip
\thing Contributed sequences A335562, A338550, A338993, A339941, A339942, and A341822
