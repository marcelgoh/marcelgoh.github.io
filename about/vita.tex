...
\leftright{Email: marcel\_goh@yahoo.ca}{}
\leftright{Webpage: marcelgoh.ca}{}
\leftright{+1\thinspace\up(825\up)\thinspace 440-0681}{}
...
\medbreak
\leftright{\bf Visiting term}{\bf January -- April 2026}
\leftright{\sl University of Cambridge}{\sl Cambridge, United Kingdom}
\smallskip
Host supervisor: Timothy Gowers.
\medbreak
...
Additive combinatorics, information theory, communication complexity, enumerative combinatorics.
...
\papercount=10
\ppubbegin P
\papitem On an entropic analogue of additive energy.
{\sl Essential Number Theory}\/ {\bf 5} (2026), 243--269.
[arXiv:2406. 18798]
...
and Theoretical Computer Science}\/ {\bf 24} (2022), \#7, 16~pp.
[arXiv:2105.12046]
\papitem (with Anna M. Brandenberger and Luc Devroye)
Root estimation in Galton--Watson trees. {\sl Random Structures and Algorithms}\/ {\bf 61} (2022), 520--542.
[arXiv:2007.05681]
...
\thing (with Csongor Beke, Hamed Hatami, Daniel Naylor, and Sean Jaffe)
A characterization of idempotent Schur multipliers.
{\sl arXiv:2607.14316} (2026), 15~pp.
\smallskip
\thing (with Hamed Hatami)
Communication complexity of point-line incidences over the reals.
{\sl arXiv:2606.25192} (2026), 12~pp.
\smallskip
\thing (with Lampros Gavalakis and Ioannis Kontoyiannis)
Entropy lower bounds and sum-product phenomena.
{\sl arXiv:2604.20233} (2026), 25~pp.
\smallskip
\thing (with Hamed Hatami)
...
\goodbreak
\sectheader{Teaching and Mentorship Experience {\rm($*$ indicates a paid position)}}

\starleftright{\bf Course lecturer}{\bf August 2024 -- present}
\leftright{\sl McGill University}{\sl Montr\'eal, QC, Canada}
\smallskip
Duties include preparing and delivering lectures to one section (section size indicated in list below),
designing assignment and exam questions, and holding office hours.
\begingroup\parindent=10pt
\smallskip
\thing Fall 2026: MATH 140 Calculus 1 (400 students)
\smallskip
\thing Fall 2024: MATH 240 Discrete Structures (179 students)
\endgroup
\medbreak

\starleftright{\bf Teaching assistant}{\bf September 2021 -- December 2025}
\leftright{\sl McGill University}{\sl Montr\'eal, QC, Canada}
\smallskip
...
\endgroup
\smallskip
Duties include giving tutorials, holding office hours, and
grading assignments and exams.
\medbreak

\leftright{\bf Directed Reading Program mentor}{\bf January 2022 -- April 2024}
\leftright{\sl McGill University}{\sl Montr\'eal, QC, Canada}
\smallskip
...
\begingroup\frenchspacing\parindent=10pt
\thing Block complexity and idempotent Schur multipliers. 29 April 2026, Discrete Analysis, Cambridge.
\smallskip
\thing ------. 7 December 2025, CMS Winter Meeting, Toronto.
\endgroup
...
\fictioncount=6
\pubbegin F
\ficitem ``{\`A elle de d\'ecider,}'' {\sl The Dalhousie Review} {\bf 105},1 (2026), 84--98.
\ficitem ``Syazwani,'' {\sl The Ex-Puritan} {\bf 71} (2025), online.
...
\smallskip
Founding member and director of a non-profit organization
that publishes poetry, prose, and art in a semiannual print magazine.
In charge of English short fiction submissions as well as the overall typesetting.
Share duties with other editors related to emails, sales, and magazine launches.
\medbreak
...
which was
organised by Bocconi University in collaboration with the University of Oxford
...
\CEE, OCaml, Python, Java, PostScript, {\mc MIPS} Assembly.
\medbreak
