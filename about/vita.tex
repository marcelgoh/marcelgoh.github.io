...
\leftright{Citizen of Canada and Singapore}{2-9602 74th Avenue NW}
...
\thing An uncertainty principle for M\"obius inversion on posets. {\sl arXiv:2302.02466} (2023), 7~pp.
\smallskip
\thing (with Jonah Saks)
On the homology of several number-theoretic set families. {\sl arXiv:2206.12535} (2022), 16~pp.
\endgroup
...
\leftright{\bf Probabilistic analysis of branching processes}{\bf May 2020 -- June 2022}
\leftright{\sl Research group}{\sl McGill University}
\smallskip
Research on branching processes, headed by Luc Devroye. Studied estimation problems
...
\starleftright{\bf After school care supervisor}{\bf January 2023 -- present}
\leftright{\bf Suzuki Charter School}{\sl Edmonton, AB, Canada}
\smallskip
Supervise and facilitate activities (e.g., arts and crafts, soccer, board games, drawing/colouring) for children
in grades 1 through 6.
\medbreak

\starleftright{\bf Software developer}{\bf January 2023 -- present}
\leftright{\bf Levven}{\sl Edmonton, AB, Canada}
\smallskip
Develop firmware for the manufacture and function of in-home IoT gateways, smart switches,
