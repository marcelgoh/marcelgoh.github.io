...
\leftright{+1\thinspace\up(825\up)\thinspace 440-0681}{2-9602 74 Avenue NW, Apt.\ 4}
\leftright{Email: marcel\_goh@yahoo.ca}{Edmonton, AB T6E 1E6}
\leftright{Webpage: marcelgoh.ca}{Canada}
...
\leftright{\bf Tlingit verb parsing}{}
\smallskip
...
\leftright{\bf Sorting algorithms on manifolds}{}
\smallskip
...
\leftright{\bf Bytecode compiler and interpreter}{}
\smallskip
...
\leftright{\bf Alonzo $\lambda$-calculus interpreter}{}
\smallskip
...
\leftright{\bf Escape-time fractals}{}
\smallskip
...
The lattice of arithmetic progressions. {\sl arXiv:2106.05949} (2021), 15~pp.
\endgroup
