...
% Probability
\def\pr{\mathop{\hbox{\bf P}}\nolimits}
\def\ex{\mathop{\hbox{\bf E}}\nolimits}
\def\var{\mathop{\hbox{\bf V}}\nolimits}
\def\one{\mathop{\bf 1}\nolimits}
\def\ind#1{\one_{[#1]}}
...
\def\refoldno#1{({\oldstyle#1})}
\def\nonameoldno{\oldno{\the\eqcount}\global\advance\eqcount by 1}
