...
\proof Let $A$ denote the set of all algebraic numbers and suppose, towards a contradiction, that all real numbers are algebraic. Then ${\bf R}\subset A$. But the set of real numbers is uncountable and we know from Problem 2 that $A$ is countable. The contradiction completes the proof.\slug
