...
For the other inequality, we apply Lemma~\ref{\lemfiveone} with $W = Y-Z$ (and the variable $Z$ in that lemma
...
and we can substitute the inequality~\refeq{\eqfoursum} to get $I_1\le 2\eta k$.
...
by independence and the fact that subtraction is addition in $G$. Since
$\dd\{X_1, X_2\}=k$, rearranging completes
the proof.\slug
