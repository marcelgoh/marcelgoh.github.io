...
\proclaim Lemma {\advthm}. For every $\theta\in \RR$, $\eps>0$, and $n\in \NN$ sufficiently large, the
...
But by applying rotations as above, each of the terms in the sum can is equal to $\bigl|1-e(d\theta)\bigr|$,
