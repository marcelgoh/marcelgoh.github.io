...
Imagine a robot that lives on the line of integers. It starts at the point $0$
and can hop in steps of $a$ or $b$ (in either direction). Theorem~{\thmbezout} tells us
that the point $d = \gcd(a,b)$ is reachable by the robot. The next proposition characterises
the set of {\it all} points that the robot can get to.
...
\noindent\datestamp{13}{} {\it Proof.}\enspace The proof that such a decomposition of $n$ exists is
