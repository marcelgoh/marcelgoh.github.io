...
\vskip \medskipamount \hbox to\hsize {\relax \unhcopy \strutbox \cont
...
By (i) again, we have $[x] = [y]$, so $[x] \cap [y] = [x] \ne \emptyset$,
where we know that $[x]\ne \emptyset$ because it contains at least $x$.\slug

\noindent
\datestamp{11}{} \hskip\parindent Let $A$ be a set. A {\it partition} of $A$ is a set $P$ of subsets
