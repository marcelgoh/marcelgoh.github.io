...
$$E \subseteq \bigl\{ \{u,v\} : u,v\in V\bigr\}.$$
...
For instance, we might have $V = \{1,2,3,4\}$ and
$$E = \{12, 13, 14, 24\}.$$
...
We can define graphs in a more complicated manner. Let $G = (V,E)$
be the graph with $V = \ZZ/5\ZZ$ and $ab\in E$ if and only if
