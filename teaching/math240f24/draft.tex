...
\medskip\boldlabel\datestamp{18}{} Walks, paths, and cycles.
...
\medskip\boldlabel\datestamp{19}{} Bipartite graphs.
...
Another characterisation of trees is that they are exactly the connected graphs with $n-1$
...
\proclaim\datestamp{20}{} Theorem \advthm. A graph $G = (V,E)$ is a tree if and only if
